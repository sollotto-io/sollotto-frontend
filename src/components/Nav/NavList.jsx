...
export default function NavList(props) {
	...
	return (
		...
		>
			...
			<a onClick={props.onNavLinkClick} rel="noopener noreferrer" target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSdMRU7GzeNDukSv-Gq9VJk_rtjVxR5CL-M33GZn8fjrCNxmwA/viewform" className="navLink">Suggest</a>
