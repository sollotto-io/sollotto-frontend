...
export default function Nav() {
  ...
  return (
    <nav>
      ...
      <span style={{display:"grid", gridTemplateColumns:"auto auto", columnGap:10, alignItems:"center"}}>
      <p>{globalData.walletConnectedFlag &&(globalData.walletBalance!==null) ? `${(globalData.walletBalance/1000000000).toFixed(2)} SOL` : ""}</p>
      <WalletConnect />
      </span>
